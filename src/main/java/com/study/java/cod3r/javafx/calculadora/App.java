...
public class App extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		Font.loadFont(getClass().getResource("/com.study.java.cod3r.javafx.calculadora/Roboto.ttf").toExternalForm(), 10);
		String css = getClass().getResource("/com.study.java.cod3r.javafx.calculadora/Calculadora.css").toExternalForm();
